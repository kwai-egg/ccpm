...
echo "  /pm:update-init        - Initialize update system for project"
echo "  /pm:update-check       - Check for available system updates"
echo "  /pm:update             - Apply system updates while preserving project data"
echo "  /pm:update-status      - Show system version and configuration"
echo "  /pm:update-rollback    - Rollback to previous backup"
echo ""
